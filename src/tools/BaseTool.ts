import { Tool as SDKTool, TextContent, ImageContent } from "@modelcontextprotocol/sdk/types.js";
import { z } from "zod";
import {zodToJsonSchema} from "zod-to-json-schema";
import { logger } from "../core/Logger.js";

type ZodRawShape = Parameters<typeof zodToJsonSchema>[0];
type ZodRawShapeType = { type: string } & ReturnType<typeof zodToJsonSchema>;
  ...
  implements ToolProtocol
{
  ...
  protected abstract schema: ZodRawShape;
  [key: string]: unknown;

  get inputSchema() {
    return {
      ...zodToJsonSchema(this.schema),
      type: this.getJsonSchemaType(this.schema) as any,
    }
  }
